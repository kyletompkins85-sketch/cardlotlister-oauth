...
"""CLI for Monte Carlo player rankings (same card type, different players). Core: cardmatch.pairwise_price_rankings."""
import argparse
import csv
import os
import sys
...
def main() -> None:
    ...
    try:
        result = run_monte_carlo_player_rankings_same_card_type(
            sim_rows,
            iterations=iters,
            seed=seed,
    ...
    print(f"ELIGIBLE_CT_GROUPS={result.eligible_card_types}")
